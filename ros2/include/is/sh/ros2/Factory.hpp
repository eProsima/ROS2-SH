 ...
 *        after calling the `ìs_ros2_rosidl_mix` macro in the CMakeLists.txt file
 *        of the custom ROS 2 package CMake project.
 *
...
public:
     ...
     *          This subscription object is dependant on every ROS 2 type and it is
     ...
     *
     * @param[in] topic_name The name of the topic type, used to index the subscription factory map.
     *
     ...
     *          This publisher object is dependant on every ROS 2 type and it is
     *          autogenerated in the template available in resources/convert__msg.cpp/hpp.em.
     */
     ...
     *          This service client object is dependant on every ROS 2 type and it is
     ...
     *
     * @details It allows to specify the associated ROS 2 node and the service name.
     *
     *          This Factory method returns a pointer containing the *Integration Service*
     *          ServiceProvider object created by the *Integration Service* to manage a service server.
     *          This service server object is dependant on every ROS 2 type and it is
     *          autogenerated in the template available in resources/convert__srv.cpp.em.
     */
    using ServiceProviderToFactory =
...
struct FactoryRegistrar
{
     ...
     *            be created by the Integration Service Core (namely, a DynamicType or ROS2 entity).
     */
    FactoryRegistrar(
...
using ServiceProviderToFactoryRegistrar =
        FactoryRegistrar<Factory::ServiceProviderToFactory, &Factory::register_server_proxy_factory>;
